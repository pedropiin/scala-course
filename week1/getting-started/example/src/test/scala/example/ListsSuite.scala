...
class ListsSuite extends munit.FunSuite:
  ...
  test("sum of a lot of numbers") {
    val list1 = List(27, 2, 15, 36, 88, 93, 39, 93, 51, 40, 12, 80, 57, 29, 89, 1, 33, 25, 62, 46, 66, 57, 85, 72, 22, 79, 23, 5, 70, 16)
    assert(sum(list1) == 1413)
  }

  test("negative numbers") {
    val list1 = List(-5, 5, -4, 3, 8, -2)
    assert(sum(list1) == 5)
  }
